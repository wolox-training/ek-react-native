export const ITEMS = [
  { name: 'Check email', checked: false },
  { name: 'Take a shower', checked: false },
...
export const PLACEHOLDER_IMAGE = 'https://i0.wp.com/hifadhiafrica.org/wp-content/uploads/2017/01/default-placeholder.png';
